...
#if defined(MY_ABC_HERE) && defined(MY_ABC_HERE) && !defined(CONFIG_SYNO_BRASWELL) && !defined(MY_ABC_HERE) && !defined(CONFIG_SYNO_DENVERTON) && !defined(CONFIG_SYNO_COFFEELAKE) && !defined(CONFIG_SYNO_GEMINILAKE) && !defined(CONFIG_SYNO_V1000)
